...
def _generate_python_fixture(session, llm_spans: list, tool_spans: list) -> str:
    ...
    lines = [
        ...
        f'Generated by Agentloop — replays recorded LLM outputs as mocks.',
        f'"""',
        f'import pytest',
    ...
    lines.append(f'')
    lines.append(f'    # Agentloop: instrument your agent and assert session metrics')
...
_DIAGNOSIS_SYSTEM = """You are an expert AI agent debugging assistant embedded in Agentloop, an agent observability platform.
