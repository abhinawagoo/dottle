    ...
    <div className="min-h-screen bg-dark-bg flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-dark-surface border border-dark-border rounded-2xl p-8 shadow-card">
          <h1 className="text-base font-semibold text-ink-primary mb-1">Sign in</h1>
          <p className="text-xs text-ink-muted mb-6">Monitor your AI agents in real-time</p>
        ...
        <p className="text-center text-xs text-ink-muted mt-5">
          No account?{" "}
          <Link href="/register" className="text-brand-400 hover:text-brand-400/80 transition-colors">
            Create one
          </Link>
        </p>
      </div>
